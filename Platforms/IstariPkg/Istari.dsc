...
################################################################################
[Defines]
  PLATFORM_NAME                  = Istari
  PLATFORM_GUID                  = b6325ac2-9f3f-4b1d-b129-ac7b35ddde62
  PLATFORM_VERSION               = 0.1
  DSC_SPECIFICATION              = 0x00010005
  OUTPUT_DIRECTORY               = Build/IstariPkg
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = IstariPkg/Istari.fdf
  SECURE_BOOT                    = 1
  USE_PHYSICAL_TIMER             = 1

  USE_SCREEN_FOR_SERIAL_OUTPUT    = 0
  USE_UART_GENI_FOR_SERIAL_OUTPUT = 0
  USE_UART_DM_FOR_SERIAL_OUTPUT   = 1
...
!include IstariPkg/Device/$(TARGET_DEVICE)/Defines.dsc.inc

[BuildOptions.common]

GCC:*_*_AARCH64_CC_FLAGS = -DSILICON_PLATFORM=8996

[PcdsFixedAtBuild.common]
  # Platform-specific
  gArmTokenSpaceGuid.PcdSystemMemorySize|0x80000000            # 2GB

  gAndromedaPkgTokenSpaceGuid.PcdABLProduct|"msmthulium"
...
[LibraryClasses.common]
  ...
  PlatformMemoryMapLib|IstariPkg/Device/$(TARGET_DEVICE)/Library/PlatformMemoryMapLib/PlatformMemoryMapLib.inf

  # Move PlatformConfigurationMapLib to Device/<device>/Library
  PlatformConfigurationMapLib|IstariPkg/Device/$(TARGET_DEVICE)/Library/PlatformConfigurationMapLib/PlatformConfigurationMapLib.inf
...
!include IstariPkg/Device/$(TARGET_DEVICE)/PcdsFixedAtBuild.dsc.inc
