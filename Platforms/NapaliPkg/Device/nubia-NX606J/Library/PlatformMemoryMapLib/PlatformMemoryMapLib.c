...
static ARM_MEMORY_REGION_DESCRIPTOR_EX gDeviceMemoryDescriptorEx[] = {
    ...
    { "HLOS3"              ,0x88F00000, 0x02600000, AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK_XN },
    { "TGCM"               ,0x8B500000, 0x00A00000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, NS_DEVICE },
    ...
    { "RSRV2"              ,0x9FFE1000, 0x00001000, AddMem, SYS_MEM, SYS_MEM_CAP, RtData, WRITE_BACK_XN },
    { "Capsule Header"     ,0x9FFE2000, 0x00001000, AddMem, SYS_MEM, SYS_MEM_CAP, RtData, UNCACHED_UNBUFFERED_XN },
    { "RSRV3"              ,0x9FFE3000, 0x00014000, AddMem, SYS_MEM, SYS_MEM_CAP, RtData, WRITE_BACK_XN },
    ...
    { "RAM Partition"      ,0x0A0000000, 0x080000000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN },
    { "RAM Partition"      ,0x120000000, 0x020000000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN },
    { "RAM Partition"      ,0x140000000, 0x080000000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN },
    { "RAM Partition"      ,0x1C0000000, 0x03D1A0000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN },
